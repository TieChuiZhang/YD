...
//    NSLog(@"%lu",(unsigned long)CURRENT_BOOK_MODEL.chapters.count);
//    NSLog(@"%ld", (long)[XDSReadManager sharedManager].bookModel.record.currentChapter);
    
}

//- (void)not
//{
//    NSUInteger allPage = CURRENT_BOOK_MODEL.chapters.count;
//    NSInteger currentPage = [XDSReadManager sharedManager].bookModel.record.currentChapter;
//    NSDictionary *dic = @{@"allpage":@(allPage) ,@"currentPage":@(currentPage)};
//    //[[NSNotificationCenter defaultCenter] postNotificationName:@"not" object:dic];
//     //NSNotificationCenter *center = [NSNotificationCenter defaultCenter];
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"cesuo" object:nil userInfo:dic];
//}
...
- (nullable UIViewController *)pageViewController:(UIPageViewController *)pageViewController
    ...
    //NSLog(@"返回上一页===%zd count", pageViewController.viewControllers.count);
    _pageChange = _page;
    ...
    return [self.manager readViewWithChapter:&_chapterChange
                                                          page:&_pageChange
                                                       pageUrl:nil];
}
...
- (nullable UIViewController *)pageViewController:(UIPageViewController *)pageViewController
    ...
    //NSLog(@"要开始往下一页翻页了===%zd count", pageViewController.viewControllers.count);
...
- (void)pageViewController:(UIPageViewController *)pageViewController
   ...
   previousViewControllers:(NSArray *)previousViewControllers
    ...
    [self.manager updateReadModelWithChapter:_chapter page:_page];
