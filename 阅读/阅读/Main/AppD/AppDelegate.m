...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    LeeTabBarController *rootViewController=[[LeeTabBarController alloc]init];
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"zaici" object:nil userInfo:nil];
}
...
//    
    ...
    while (fileName = [dirEnum nextObject]) {
        NSString *newPath = [NSHomeDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"Documents/%@",fileName]];
        NSString *oldPath = [NSHomeDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"Documents/Inbox/%@",fileName]];
